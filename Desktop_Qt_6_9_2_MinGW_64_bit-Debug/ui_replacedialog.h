...
public:
    ...
    void setupUi(QDialog *ReplaceDialog)
    {
        ...
        btFindfNext = new QPushButton(ReplaceDialog);
        btFindfNext->setObjectName("btFindfNext");

        verticalLayout->addWidget(btFindfNext);
    ...
    void retranslateUi(QDialog *ReplaceDialog)
    {
        ...
        groupBox->setTitle(QCoreApplication::translate("ReplaceDialog", "\346\226\271\345\220\221\357\274\232", nullptr));
        ...
        btFindfNext->setText(QCoreApplication::translate("ReplaceDialog", "\346\237\245\346\211\276\344\270\213\344\270\200\344\270\252(F)", nullptr));
